...
const getSalesData = require("../services/salesData.js");
...
const getSalesReport = async (req, res) => {
    try {
      ...
      console.error(`error while getting the sales report \n ${error}`);
    }
  };
  ...
  const salesReportFilter = async (req,res)=>{
    try {
      ...
      console.error(`error while filtering the sales report \n ${error}`);
  ...
  const salesReportFilterCustom = async (req,res)=>{
    try {
      ...
      console.error(`error while custom filtering the sales report \n ${error}`);
    }
  }
  ...
  const salesReportDownloadPDF = async (req,res)=>{
    try {
      ...
      console.error(`error while downloading the sales report PDF \n ${error}`);
    }
  }
  ...
  const salesReportDownload = async (req,res)=>{
    try {
      ...
      console.error(`error while downloading the sales report \n ${error}`);
